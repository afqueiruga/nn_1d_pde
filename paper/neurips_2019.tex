...
\begin{abstract}
  ...
  of neural networks to solving well understood aprtial differential
  equations.
  Burger's equation and the Korteweg-de Vries equation are treated,
  which even in their 1D form are challenging to solve numerically due
  to their nonlinearity and exhibition of shock fronts.
...
The experiments are designed to take a few minutes of compute time training to replicate.
...
The Poisson Equation, a linear elliptic equation,
\begin{equation}
u_{xx} = f
\end{equation}
The Heat Equation, a linear parabolic equation,
\begin{equation}
u_{xx} = u_t
\end{equation}
...
\end{equation}
  ...
  Burger's equation, a conservative nonlinear equation known for
